...
config. Authoritative source: `docs/constitution.md` § "Hard rules" (Zod boundary).
...
- **Config:** new keys go through the project's typed config module's Zod schema with a default — never read raw `process.env` for module activation.
