...
Loaded when editing any TypeScript file. Authoritative source: `docs/constitution.md`
§ "Hard rules".
...
- Keep escape hatches out of shared `@your-org/*` surfaces entirely — a published type is a contract.
