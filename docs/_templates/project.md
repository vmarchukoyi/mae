<!--
PROJECT.md TEMPLATE — copy to docs/PROJECT.md, generated/refreshed by /project-explore.
...
building and why" so an agent keeps the goal in view and does not hallucinate one.
  - CONSTITUTION.md = engineering non-negotiables (stack, hard rules). Different doc.
