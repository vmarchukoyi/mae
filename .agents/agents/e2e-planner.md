...
1. **Navigate and Explore**
    ...
    - In a Maeton-style monorepo there are multiple frontends (`apps/saas`, `apps/admin`, `apps/web`). Stay within the app the caller targeted — do not wander into a different app's URL space.
